test_that("filter_delivered returns expected results", {
...
test_that("filter_delivered handles different column names", {
  # Create a sample dataframe for testing
  df <- data.frame(
...
test_that("filter_delivered throws an error for invalid col_name input", {
  # Create a sample dataframe for testing
  df <- data.frame(
    tracking_status = c(1, 2, 3, 3, 1, 3, 2),
    other_column = c("A", "B", "C", "D", "E", "F", "G")
